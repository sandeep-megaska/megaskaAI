...
export default function ProviderHealthPage(){
 ...
 return <PageShell accent="violet" eyebrow="Operations" title="AI Provider Health" description="Observed model traffic, concurrency and RESOURCE_EXHAUSTED diagnosis from Megaska AI." rail={null}>
