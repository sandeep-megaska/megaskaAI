      ...
      <div className="mx-auto max-w-[1800px] space-y-6">
        <div id="auto-produce" className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <Link href="/studio/video/v2/create-clip" className="rounded border border-zinc-700 px-3 py-2 text-sm hover:bg-zinc-900">Create Clip</Link>
            <Link href="/studio/video/v2/working-packs-review" className="rounded border border-zinc-700 px-3 py-2 text-sm hover:bg-zinc-900">Working Packs</Link>
