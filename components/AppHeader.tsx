...
import { Activity, ChevronDown, ImageIcon, PanelsTopLeft, Video, Wallet } from "lucide-react";
...
const navItems = [
  ...
  { href: "/provider-health", label: "Provider Health", icon: Activity, accent: "violet" as const },
  // Kept for future use:
