...
function buildSystemInstructions() {
  return [
    ...
    "videoPrompt must be short-clip friendly (single compact paragraph) and practical for direct model input.",
    "videoPrompt must stay provider-safe: no celebrity likeness, no unsafe content requests, no trademark/logo invention.",
    "videoPrompt should prefer one primary camera move and at most one secondary adjustment; avoid overloaded multi-move choreography.",
    "videoPrompt should align with Megaska workflow: continuity-safe motion, clear subject action, stable scene constraints, and feasible 4-8s execution.",
